...
- Trainable parameters: **41,943,040** (cross-checked against the pre-training QLoRA setup; no precise percentage is claimed)
...
- Hardware: Tesla T4 (recorded by setup and training artifacts)
- Adapter size: 167,838,575 bytes (verified by the release manifest)
